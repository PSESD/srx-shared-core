...
trait SrxServer extends ServerApp {
  ...
  def logMessage(resource: String, method: String, zoneId: Option[SifZone], resourceId: Option[String], parameters: SifRequestParameterCollection, requestBody: Option[String], statusCode: String, description: String) : SifResponse ={
  ...
  def logNotFoundMessage(resource: String, method: String, resourceId: Option[String], parameters: SifRequestParameterCollection, requestBody: Option[String]) : SifResponse = {
  ...
  def logSuccessMessage(resource: String, method: String, resourceId: Option[String], parameters: SifRequestParameterCollection, requestBody: Option[String]) : SifResponse = {
    val zoneId = if (parameters("zoneId").isDefined) Some(SifZone(parameters("zoneId").get)) else None
